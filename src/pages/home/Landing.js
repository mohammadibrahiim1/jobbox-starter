  ...
  return (
    <div ref={el} className="h-screen">
      <div className="max-w-2xl h-[80vh] rounded-b-full absolute top-0 left-1/2 -translate-x-1/2 overflow-hidden z-0">
        <img id="hero1" src={hero1} alt="" className="object-cover h-full w-full opacity-0" />
        <img id="hero2" src={hero2} alt="" className="object-cover h-full w-full opacity-0" />
        <img id="hero3" src={hero3} alt="" className="object-cover h-full w-full opacity-0" />
      </div>
        ...
        <div className="flex w-full">
          ...
          <div className="flex flex-col justify-between ">
            ...
            <div className="statCard rounded-3xl shadow-2xl p-7 bg-white relative left-[60%]">
              ...
              <p className="font-light text-gray-500">In Marketing & Communication</p>
            </div>
