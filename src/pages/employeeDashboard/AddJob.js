...
const AddJob = () => {
  const [postJob, { isLoading, error, isError }] = usePostJobMutation();
  ...
  const { fields: reqFields, append: reqAppend, remove: reqRemove } = useFieldArray({ control, name: "requirements" });
    ...
    <div className="flex justify-center items-center overflow-auto p-10">
      ...
      >
        ...
        <div className="flex flex-col w-full max-w-xs">
          ...
          <input disabled className="cursor-not-allowed" type="text" id="companyName" {...register("companyName")} />
        </div>
        <div className="flex flex-col w-full max-w-xs">
